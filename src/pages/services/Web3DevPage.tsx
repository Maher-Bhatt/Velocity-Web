    ...
    <section className="section-space">
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-white">Web3 is still a product experience problem</h2>
          ...
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-white">UX matters more here, not less</h2>
            <p className="mt-4 text-sm leading-relaxed text-[#b7b7c6]">
