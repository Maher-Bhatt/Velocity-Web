    ...
    <section className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-10">
      <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <TiltCard className="glass-card p-6">
          <p className="text-sm uppercase tracking-[0.18em] text-[#6366f1]">Good fit if</p>
    ...
    <section className="section-space">
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Speed beats theoretical perfection</h2>
          ...
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Iteration needs a flexible stack</h2>
            <p className="mt-4 text-sm leading-relaxed text-[#b7b7c6]">
      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Discovery</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">Clarify the offer and the user action</h3>
          ...
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Design</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">Product clarity over decoration</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Build</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">React, Node.js, and practical integrations</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Deploy</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">Get live, then improve from data</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
