      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <TiltCard className="step-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-[#d7ff71]">A clear path from search to content</h3>
          ...
          <TiltCard className="step-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-[#d7ff71]">Less interface, more usefulness</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="step-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-[#d7ff71]">Critical for real student use</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="step-card p-6">
            ...
            <h3 className="mt-4 text-lg font-semibold text-[#d7ff71]">Only the functionality students needed</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
