  ...
  <SiteLayout>
    ...
    <section className="section-space">
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Fast note access mattered most</h2>
          ...
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Existing tools were overkill</h2>
            <p className="mt-4 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Mobile-first use was expected</h2>
            <p className="mt-4 text-sm leading-relaxed text-[#b7b7c6]">
      ...
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Lightweight React frontend</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">A clear path from search to content</h3>
          ...
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Simple UI choices</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">Less interface, more usefulness</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Mobile-first layout behavior</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">Critical for real student use</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="step-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Custom product scope</h2>
            <h3 className="mt-4 text-lg font-semibold text-[#818cf8]">Only the functionality students needed</h3>
            <p className="mt-3 text-sm leading-relaxed text-[#b7b7c6]">
    ...
    <section className="section-space pb-20">
      <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Simplicity beats feature overload</h2>
            <p className="mt-4 text-sm leading-relaxed text-[#b7b7c6]">
          ...
          <TiltCard className="glass-card p-6">
            <h2 className="font-display text-2xl text-[#0f0f1a]">Mobile-first cannot be an afterthought</h2>
            <p className="mt-4 text-sm leading-relaxed text-[#b7b7c6]">
