...
const services = [
  ...
  },
  {
    ...
    description:
      "Launch your product with a clean, modern website or app. Built for startups that need momentum without agency drag.",
        ...
        <div className="space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              { value: "1-2 weeks", label: "Typical delivery window" },
            ].map((item) => (
